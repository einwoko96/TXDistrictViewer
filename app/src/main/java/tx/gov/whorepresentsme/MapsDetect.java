...
public class MapsDetect extends FragmentActivity implements OnMapReadyCallback {

    private static final String TAG = MapsDetect.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_detect);
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (mLastKnownLocation != null) {
                                retIntent.putExtra(Constants.KEY_LOCATION, mLastKnownLocation);
